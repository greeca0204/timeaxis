...
?>
        <div id="menu">
            ...
            <ul>
				...
				<li class="main">
                    <a class="parent" href="javascript:void(0);" style="background:#069;">事件信息管理</a>
                    <ul>
                    	<li><a href="event.php?action=new" target="mainFrame">添加事件信息</a></li>
                    	<li><a href="event.php" target="mainFrame">事件信息管理</a></li>              	
                    </ul>
                </li>
